...
// class ParamArray: public Cloneable<ParamArray, Variable> {
// protected:
// 	DataType element_dt = BuildTypes::undefinedType;
// 	string element_dt_name;
// public:
// 	ParamArray(const string& n, string element_dt_name, location_t loc): Cloneable<ParamArray, Variable>(n, loc) {
// 		this->element_dt_name = element_dt_name;
// 	}

// 	ParamArray(const string &n, DataType dt, location_t loc): Cloneable<ParamArray, Variable>(n, loc) {
// 		this->dt = dt;
// 		this->element_dt = buildTypes->getArrayElementType(dt);
// 	}

// 	ParamArray(const ParamArray &other, TypeSubs &ts)
// 		: Cloneable<ParamArray, Variable>(other, ts)
// 	{
// 		this->element_dt_name = other.element_dt_name;

// 		// Se o tipo concreto já foi resolvido, preserva:
// 		if (other.dt != BuildTypes::undefinedType)
// 		{
// 			this->dt = other.dt;
// 			this->element_dt = buildTypes->getArrayElementType(this->dt);
// 		}
// 	}
...
// class Array: public Cloneable<Array, Variable> {
// protected:
// 	unsigned int size;
// 	DataType element_dt = BuildTypes::undefinedType;
...
// 	Array(const Array& arr, TypeSubs& ts);
